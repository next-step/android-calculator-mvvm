...
class ExpressionTest {
    ...
    fun `'8 +' 수식이 있을 때, + 연산자를 - 연산자로 변경할 수 있어야 한다`() {
        // given
        val expression = edu.nextstep.camp.domain.Expression(listOf(8, edu.nextstep.camp.domain.Operator.Plus))
    ...
    fun `'32 + 1' 수식이 있을 때, 마지막 1을 제거할 수 있어야 한다`() {
        // given
        val expression = edu.nextstep.camp.domain.Expression(listOf(32, edu.nextstep.camp.domain.Operator.Plus, 1))
    ...
    fun `'32 +' 수식이 있을 때, 마지막 +를 제거할 수 있어야 한다`() {
        // given
        val expression = edu.nextstep.camp.domain.Expression(listOf(32, edu.nextstep.camp.domain.Operator.Plus))
